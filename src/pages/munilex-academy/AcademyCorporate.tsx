      ...
      <section className="relative pt-48 pb-32 px-6 md:px-8 overflow-hidden bg-[#0E0E0E]">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          <motion.h1 
            ...
            className="text-4xl md:text-6xl font-black text-white leading-[0.85] tracking-tighter mb-10 uppercase font-manrope"
          >
            TU MARCA, NUESTRA <br/>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            >
              <div className="flex items-center gap-4 mb-10 relative">
                <div className="w-14 h-14 bg-[#2A2A2A] rounded-2xl flex items-center justify-center text-[#d4af37] group-hover:scale-110 transition-transform font-manrope">
              ...
              <div className="flex-grow">
                <h3 className="text-3xl font-black text-white mb-2 uppercase tracking-tighter leading-none font-manrope">Plan Iniciación</h3>
                ...
                <p className="text-white/60 font-medium leading-relaxed mb-10">
                  Integración del ecosistema MUNILEx con acceso a 2 oposiciones del catálogo. Incluye: Tests ilimitados, Casos prácticos corregidos por IA, Flashcards de repaso y Asistente AI.
                </p>
                
                <div className="space-y-6 mb-12">
                  <div className="p-6 bg-white/5 rounded-3xl border border-white/5">
                    <div className="text-[10px] font-black uppercase text-[#d4af37] tracking-[0.2em] mb-3">Alcance & Tiempos</div>
                    <div className="space-y-4">
                      <div className="flex justify-between items-center text-xs font-bold">
                        <span className="text-white/40">Oposiciones</span>
                        <span className="text-white">2 del catálogo</span>
                      </div>
                      <div className="flex justify-between items-center text-xs font-bold">
                        <span className="text-white/40">Entrega aprox.</span>
                        <span className="text-white">1 - 2 semanas</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6 bg-[#d4af37]/5 rounded-3xl border border-[#d4af37]/10">
                    ...
                    <div className="space-y-2 text-xs font-black uppercase font-manrope">
            ...
            >
              ...
              <div className="flex-grow">
                <h3 className="text-3xl font-black text-white mb-2 uppercase tracking-tighter leading-none font-manrope">Plan Marca</h3>
                <div className="text-[#d4af37] italic font-bold mb-8 uppercase text-sm tracking-widest">"Tu tecnología propia"</div>
                
                <p className="text-white/60 font-medium leading-relaxed mb-10">
                  Incluye TODAS las oposiciones de nuestro catálogo y todas las funciones del Plan Iniciación. Suma personalización completa de marca (logo, colores, entorno) y soporte prioritario.
                </p>
                ...
                <div className="space-y-6 mb-12">
                  ...
                  <div className="p-6 bg-[#d4af37] rounded-3xl border border-[#d4af37]">
                    ...
                    <div className="space-y-2 text-xs font-black uppercase text-black font-manrope">
            ...
            >
              ...
              <div className="flex-grow">
                <h3 className="text-3xl font-black text-white mb-2 uppercase tracking-tighter leading-none font-manrope">Plan Ecosistema</h3>
                <div className="text-[#d4af37] italic font-bold mb-8 uppercase text-sm tracking-widest">"Tu sistema educativo propio"</div>
                
                <p className="text-white/60 font-medium leading-relaxed mb-10">
                  Desarrollo 100% personalizado, funcionalidades ilimitadas, integración total de metodologías propias e infraestructura dedicada.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-black text-white leading-tight tracking-tighter mb-12 uppercase font-manrope">
                INFRAESTRUCTURA <br/>
              ...
              <div className="space-y-10">
                {[
                  ...
                  { t: "Seguridad y Cumplimiento", d: "Plataforma alineada con el EU AI Act y normativa de Protección de Datos.", icon: <Shield /> },
                  ...
                  <div key={i} className="flex gap-6">
                    ...
                    <div>
                      <h4 className="text-xl font-black text-white uppercase tracking-tight mb-2 font-manrope">{item.t}</h4>
            ...
            <div className="relative">
              ...
              <div className="bg-[#1C1B1B] border border-white/5 p-12 rounded-[4rem] relative z-10">
                <div className="text-center mb-10">
                  <h3 className="text-3xl font-black text-white uppercase tracking-tight leading-none mb-2 font-manrope">Presupuestos</h3>
                  <div className="text-[#d4af37] font-bold uppercase text-[10px] tracking-[0.3em]">Cerrados y Transparentes</div>
                </div>
                <p className="text-white/50 text-center text-lg leading-relaxed mb-10 font-medium">
