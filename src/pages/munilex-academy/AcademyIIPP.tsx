    ...
    <div className="pt-48 pb-24 min-h-screen bg-[#131313] text-[#E5E2E1] px-6 md:px-8 relative overflow-hidden font-inter selection:bg-[#ef4444]/30">
      ...
      <div className="max-w-7xl mx-auto relative z-10 pt-16">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center mb-32">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-[#ef4444]/10 text-[#ef4444] text-[10px] font-black uppercase tracking-[0.3em] border border-[#ef4444]/20 w-fit font-manrope">
               Cuerpo de Ayudantes de IIPP
            </div>
            
            <h1 className="text-4xl md:text-6xl lg:text-8xl font-black uppercase tracking-tighter leading-[0.85] text-white font-manrope">
              CONTROL <br />
            ...
            <div className="flex flex-wrap gap-4">
               <Link 
                to="/academy/precios"
                className="inline-flex items-center gap-3 px-10 py-5 bg-[#d4af37] text-black font-black uppercase tracking-widest text-[11px] rounded-xl hover:scale-105 transition-all shadow-xl shadow-[#d4af37]/10 font-manrope"
              >
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl font-black uppercase tracking-tighter text-white font-manrope">Sistemas de <span className="text-[#d4af37] italic">Control</span></h2>
          <p className="text-white/40 text-xs font-bold mt-3 uppercase tracking-widest font-manrope">Especialización en Derecho Penitenciario</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-32">
          {[
            ...
            <motion.div
              ...
              className="bg-[#1C1B1B] border border-white/5 p-10 rounded-[3rem] hover:border-[#ef4444]/30 transition-all group shadow-2xl"
            >
              ...
              <h3 className="text-2xl font-black text-white mb-4 uppercase tracking-tighter font-manrope">{f.title}</h3>
        ...
        <div className="max-w-4xl mx-auto border-t border-white/5 pt-20">
          <h2 className="text-3xl font-black mb-8 text-white uppercase tracking-tighter font-manrope italic">Preparación Instituciones Penitenciarias Élite</h2>
          <div className="space-y-6 text-white/50 font-medium leading-relaxed text-lg">
            <p>
              Alcanzar tu meta como <span className="text-[#ef4444] font-bold underline underline-offset-8 decoration-2 decoration-[#ef4444]/30">Ayudante de Instituciones Penitenciarias</span> demanda un conocimiento férreo del Código Penal y la LOGP. En Munilex Academy, forjamos operadores jurídicos de máximo nivel.
            </p>
            <p>
              Nuestro sistema genera incontables <span className="text-[#d4af37] font-black italic">casos prácticos Prisiones</span> fundamentados jurídicamente, basados estrictamente en la última normativa consolidada del BOE.
            </p>
          </div>
        </div>
      </div>
