      ...
      <section className="relative pt-48 pb-32 px-6 md:px-8 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          <motion.h1 
            ...
            className="text-2xl md:text-4xl font-black text-white leading-[0.9] tracking-tighter uppercase mb-12"
          >
            ASEGURA TU <br/>
      ...
      <section className="py-24 bg-[#131313]">
        <div className="max-w-5xl mx-auto px-6 md:px-8 text-center">
          <div className="bg-[#1C1B1B] border border-white/5 p-20 rounded-[4rem] relative overflow-hidden">
            ...
            <h2 className="text-2xl md:text-3xl font-black text-white uppercase tracking-tighter mb-10 relative z-10">¿EMPEZAMOS LA <span className="text-[#d4af37]">RACHA?</span></h2>
